...
save(phylo_otus, file = "data/phyloseq/otus_perfiltering.RData")
phylo_species <- combine_phyloseq(l_species)
save(phylo_species, file = "data/phyloseq/species_perfiltering.RData")
phylo_genera <- combine_phyloseq(l_genera)
save(phylo_genera, file = "data/phyloseq/genera_perfiltering.RData")
```
...
# sanity check
tb_1 <- readxl::read_xlsx("tables/table1/assets/table1_metadata.xlsx",
                          sheet = 1)
...
tb_libSize_summary <- tb_libSize %>% 
  ...
  dplyr::summarise(mean_libSize = mean(lib_size),
                   ...
                   median_percentage = median(lib_size / original_read_count),
                   n = n(),

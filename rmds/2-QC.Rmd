...
phylo_genera <- 
  ...
  prune_taxaSamples()
boxplot(phyloseq::sample_sums(phylo_genera) / sample_data2(phylo_genera)$libSize)
phylo_species <- 
  tb_filter %>% 
  ...
  prune_taxaSamples()
boxplot(phyloseq::sample_sums(phylo_species) / sample_data2(phylo_species)$libSize)
